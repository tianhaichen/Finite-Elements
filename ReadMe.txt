...
????????Windows????,???Linuxl?????????--??????????????????,????????????
1.    ?GMSH???????(??,Post/???),??GMSH dll??????sil?????
2.    ?????ProjectPreProcessing,???????????:"FiniteElements\ProjectPreProcessor\out\build\x64-Debug\ myfems .exe"
3.    ???????,???????????:"Finite-Elementslout\build\x64Debug\ myfem.com .exe"
4.    ?????ProjectPostProcessing,???????????:"FiniteElements\ProjectPostProcessor\out\build\x64-Debug\ myfems .exe"
5.    ????????(D,V,K)????????
?????????????,??1??4???5??????
????????????,???????????(??????)???????????main.c???????????
????????????homework.c????
